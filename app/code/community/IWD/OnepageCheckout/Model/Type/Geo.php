<?php
include("MaxMind/GeoIP/geoip.php");
include("MaxMind/GeoIP/geoipcity.php");
...
class IWD_OnepageCheckout_Model_Type_Geo
{
    ...
    public function getCheckoutMethod()
    {
        ...
        { 
            if (Mage::helper('onepagecheckout')->isGuestCheckoutAllowed($this->getQuote()))
...
// fix (26.10.13) (when user change shipping address, system does not resave this parameter)
    ...
    public function validate()
    {
        ...
        if (!Mage::helper('onepagecheckout')->isGuestCheckoutAllowed($quote) && $quote->getCheckoutMethod() == self::GUEST)
