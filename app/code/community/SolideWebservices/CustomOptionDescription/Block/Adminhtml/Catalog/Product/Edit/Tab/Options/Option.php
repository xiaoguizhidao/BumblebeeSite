...
class SolideWebservices_CustomOptionDescription_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Option extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options_Option {
	...
	public function getOptionValues() {
		...
		if (!$this->_values) {
			...
			foreach ($optionsArr as $option) {
				/* @var $option SolideWebservices_CustomOptionDescription_Model_Catalog_Product_Option */
