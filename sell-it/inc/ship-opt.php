...
<?php if($shipAddress): ?>
<option value="<?php echo $myadr->add_id; ?>"<?php if($myadr->add_id==$shipAddress):?> selected<?php endif; ?>><?php echo $myadr->address_name;//echo $name.' '.$lname.' '.$myadr->address_name; ?></option>
<?php else: ?>
<option value="<?php echo $myadr->add_id; ?>"><?php echo $name.' '.$myadr->address_name; ?></option>
<?php endif; ?>
<?php endforeach; ?>
</select>
