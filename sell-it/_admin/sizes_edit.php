...
$qryNews="select * from sizes where size_id='$size_id' limit 1";
...
if(isset($_POST['submit'])){
	...
	$qryUpdate="update sizes set sizename='$sizename', sort='$sort' where size_id='$size_id'";
                    ...
                    <td valign="top" background="images/usr_bg2.jpg" style="background-repeat:repeat-x;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td valign="middle" style="padding-top:10px;">
                              <form id="form1" name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF'].'?size_id='.$_GET['size_id'];?>" enctype="multipart/form-data">
                              <table width="100%" border="0" align="left" cellpadding="0" cellspacing="3">
                                <tr> 
                  <td> <b>Size Name</b></td>
                  <td><input name="sizename" type="text" class="textbox1" id="sizename" style="border-width:1; border-style:solid;font-size:10; " size="40" value="<?php echo $rowNews['sizename'];?>"></td>
                   <td>&nbsp;</td>
              </tr>
                                ...
                                <tr>
                                 ...
                                 <tr> 
                  <td> <b>Ranking</b></td>
                  <td><input name="sort" type="text" class="textbox1" id="sort" style="border-width:1; border-style:solid;font-size:10; " size="40" value="<?php echo $rowNews['sort'];?>"></td>
                   <td>&nbsp;</td>
              </tr>
