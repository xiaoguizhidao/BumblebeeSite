...
if (r==true)
  {
 window.location="download.php?pdf_id=<?php echo($rsColors['pdf_id']."&action=delete_image"); ?>";
  }
  else
  return false;
}
...
$filename = basename($_FILES['pdf_download']['name']);
	...
	$qry="insert into download(pdf_name,pdf_size,pdf_download,pdf_image) values('$pdf_name','$pdf_size','$filename','$filename1')";
	
	if(mysql_query($qry)or die(mysql_error())){
		$msg="PDF has been added successfully";
	}else{
		$msg="There is some error in adding PDF. Please try again.";
	}
}
?>
...
<table width="90%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="center" valign="top" style="padding-top:15px;">
            <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30" class="Black_Text"><span class="orange_text">Manage PDF Downloads</span></td>
              </tr>
              <tr>
                  ...
                  <td><input name="pdf_image" type="file" class="textbox1" id="pdf_image" style="border-width:1; border-style:solid;font-size:10; " size="40"></td>
                   <td>&nbsp;</td>
                                ...
                                <tr>
                                  ...
                                  <td> <input type="submit" name="submit" id="submit" value="Add New PDF" /></td>
                                  <td>&nbsp;</td>
                                </tr>
                                    <tr>
                                  <td height="19" align="right" class="usr_info">&nbsp;</td>
              ...
              <tr>
                        ...
                        <tr>
                          <td height="27" colspan="2" bgcolor="#efefda" class="main_table_border"><table width="772" cellpadding="0" cellspacing="0" class="Lblack">
                            <tr>
                              ...
                              <td width="425" align="center">PDF Name</td>
			   ...
			   if ($_REQUEST['action']=="delete_image"){
				  $pdf_id=$_GET['pdf_id'];
				  $del="delete from download where pdf_id='$pdf_id'";
				  $delete=mysql_query($del) or die(mysql_error());
				}
   $sqlColors=mysql_query("select * from download order by pdf_id desc")or die(mysql_error());
			  $r=0;
  ...
  ?>
                              ...
                              <tr onMouseOver="this.style.backgroundColor='#f9f9ec';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#cccccc';">
                                ...
                                <a onClick="return confirmation()" href="download.php?pdf_id=<?php echo ($rsColors['pdf_id']."&action=delete_image"); ?>"><img src="images/icons/delete-16x16.png" alt="Delete Record" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="download_edit.php?pdf_id=<?php echo ($rsColors['pdf_id']); ?>"><img src="images/icons/icon_action.jpg" alt="Delete Record" border="0"></a>                                </td>                                
