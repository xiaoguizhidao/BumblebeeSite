  ...
  <tr>
    ...
    <td width="100%" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%"  height="100%"border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td align="center" valign="top" background="images/usr_bg2.jpg" style="background-repeat:repeat-x;"><form action="<?php echo $_SERVER['includes/PHP_SELF'];?>?p_id=<?php echo $p_id;?>" method="post" enctype="multipart/form-data">
          <table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding:10px">
  <tr>
    <td colspan="4"><?php echo $msg;?></td>
    </tr>
  <tr>
    <td width="21%" height="25"><strong>Article No</strong></td>
    <td height="25" colspan="3"><strong>Name</strong></td>
  </tr>
 <?php 
 $gllery_qry=mysql_query("select * from products")or die(mysql_error());
//$num=mysql_num_rows($gllery_qry);
// if($num>0){
 while($row=mysql_fetch_array($gllery_qry)){
 ?>
  <tr>
    <td height="20"><?php echo $row['article_no'];?></td>
    <td width="79%" height="20"><?php echo $row['name'];?></td>
    <td>&nbsp;</td>
  </tr>
  <?php }
  //}
