...
<?php 
$acc_id=$_GET['acc_id'];
$qry=mysql_query("select * from location  where loc_id='$acc_id'")or die(mysql_error());
...
$acc_id=$_GET['acc_id'];
	...
	$update_qry="update location  set name='$hn_name',loc_text='$hn_des'";
...
$update_qry.=", loc_img='$filename'";

}
$update_qry.=" where loc_id='$acc_id'";
echo $update_qry;
	if($rsUpdate=mysql_query($update_qry) or die(mysql_error())){
...
echo($_SERVER['PHP_SELF']);?>?acc_id=<?php echo $acc_id;?>" 
...
value="<?php echo $rs["name"]?>" size="26"></td>
              </tr>
...
rows="10" class="passfieds"><?php echo $rs["loc_text"]?></textarea></td>
              </tr>
...
name="honey" id="honey" class="passfieds">
                <?php 
if($rs["acc_img"]!=""){?>
<img src="../accessories/<?php echo($rs['loc_img']);?>" width="50" height="50" />
<?php }
?>(200 * 100)</td>
              </tr>
              <tr>
