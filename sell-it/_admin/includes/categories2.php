...
<td width="151" align="left" valign="middle" class="menu_text"><a href="javascript:toggleLayer('<?php echo $r;?>');" title="Add a comment to this entry"><?php echo $rs['category'].'</a>';?></td>
                                                        </tr>
                                                      </table>
...
<table width="170" border="0" cellspacing="0" cellpadding="0">
<?php while($rs1=mysql_fetch_array($q1)){?>
