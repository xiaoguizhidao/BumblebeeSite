...
if(isset($_REQUEST['country_name'])) {
	$contname = $_REQUEST['country_name'];
	$sports_id = $_REQUEST['sports_id'];
	$qr = "insert into sports_country (sports_id,country) values ('$sports_id','$contname')";
	if(mysql_query($qr)) {
		header("location: sports-country.php?id=".$sports_id);
	} else {
		$msg = "Error adding sports country".mysql_error();
	}
}
?>
    ...
    <td width="100%" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%"  height="100%"border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td align="left" valign="top" style="padding-top:15px;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="borderbtm">
            ...
            <tr><td>Country Name</td><td><input type="text" name="country_name"><input type="hidden" name="sports_id" value="<?php echo $_REQUEST['sid']; ?>"></td></tr>
            <tr><td></td><td><input type="submit" value="Add Country"><input type="reset" value="Reset"></td></tr>
            </table>
            </form>
