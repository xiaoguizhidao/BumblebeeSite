...
if(isset($_REQUEST['delete_id'])) {
	$userdelid = "delete from users where user_id=".$_REQUEST['delete_id'];
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="borderbtm">
                ...
                <tr>
                  <td width="19%" class="Lblack" style="padding-left:5px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="0%" align="left"><img src="images/sap.jpg" width="2" height="12"></td>
                        <td width="28%" class="Lblack"style="padding-left:5px;">Registered Email</td>
            ...
            <tr>
              <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                 <?php
$qry="SELECT * FROM users order by first_name, last_name";
...
?> <tr>
                    ...
                    <td width="37%" bgcolor="<?php echo $bg3;?>" class="border2" style="padding-left:5px;"><a href="view-address.php?id=<?php echo $row['user_id']; ?>"><?php echo $row['first_name'] . " " . $row['last_name'];?></a></td> 
                    <td width="27%" bgcolor="<?php echo $bg3;?>" class="border2" style="padding-left:5px;"><?php echo $row['user_email'];?></td>
                    <td width="13%" align="center" bgcolor="<?php echo $bg3;?>" class="border3"><a href="users-edit.php?user_id=<?php echo($row['user_id']);?>" title="Edit"><img src="images/icons/icon_action.jpg" width="20" height="17" border="0"></a></td>
                    <td width="11%" align="center" bgcolor="<?php echo $bg3;?>" class="border4"><a href="manage-users.php?delete_id=<?php echo($row['user_id']);?>"><img src="images/icons/icon_delete_lit.jpg" width="13" height="17" border="0"></a></td>
                    </tr><?php }?>
