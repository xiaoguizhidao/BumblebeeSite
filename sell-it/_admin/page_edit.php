...
$qry="SELECT * FROM pages where id='$page_id' limit 1";
...
<!-- /TinyMCE -->
<?php /*?><script language="javascript" src="includes/general.js"></script>
<script type="text/javascript" src="../tinymce/tiny_mce/tiny_mce.js"></script>
<script type="text/javascript">
	tinyMCE.init({
		// General options
  ...
  <tr>
    ...
    <td width="100%" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%"  height="100%"border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td align="left" valign="top" style="padding-top:15px;"><form action="editpage.php?page_id=<?php echo $rs['id'];?>" method="post" name="frmChange" enctype="multipart/form-data"><table width="500" border="0" align="center" cellpadding="2" cellspacing="0">
  <tr>
    <td colspan="2"><?php echo($msg);?></td>
    </tr>
  <tr>
    <td width="151">Page Image :</td>
    <td width="341"><input type="file" name="page_image" id="page_image"  value="<?php echo $rs['page_image'];?>"  /><img src="../page_image/<?php echo $rs['page_image'];?>" height="50" /></td>
  </tr>
  <tr>
    <td width="151">Heading Of The Page :</td>
    <td width="341"><input type="text" name="page_heading" id="page_heading"  value="<?php echo $rs['heading'];?>" /></td>
  </tr>
  <tr>
    <td>Page Description  :</td>
    <td> <textarea name="page_description" cols="63" rows="26" id="page_description"><?php echo $rs['description'];?></textarea></td>
  </tr>
  <tr>
    <td>&nbsp; </td>
    <td>&nbsp;</td>
