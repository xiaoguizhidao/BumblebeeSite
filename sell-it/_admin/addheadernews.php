...
<form action="add_headernews.php" method="post" enctype="multipart/form-data" name="frmUpdateSub" id="frmUpdateSub"><br><br>
			  <table 
...
value=""></td>
 ...
 <tr>
    <td width="23%">&nbsp;</td>
    <td width="10%">News</td>
    <td><textarea name="newsdes" id="newsdes"></textarea></td>
  </tr>
