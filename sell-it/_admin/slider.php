...
if(isset($_REQUEST['delete_slide'])) {
	$delid=$_REQUEST['delete_slide'];
	if(mysql_query("delete from slider where slide_id=$delid")) {
		?>
        <script type="text/javascript">window.location='slider.php';</script>
        <?php
	}
}
if (!isset($sRetry))
    ...
    <td width="100%" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%"  height="100%"border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td align="left" valign="top" style="padding-top:15px;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="borderbtm">
            <tr><td><a href="slider.php">Manage Slider</a></td>
            </tr>
            <tr>
                ...
                <tr>
                  <td width="19%" class="Lblack" style="padding-left:5px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="37%" class="Lblack"style="padding-left:5px;">Slide</td>
                        <td width="0%" align="left"><img src="images/sap.jpg" width="2" height="12"></td>
            ...
            <tr>
              <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                 <?php
$qry="SELECT * FROM slider order by sort asc";
...
?> <tr>
                    ...
                    <td width="37%" bgcolor="<?php echo $bg3;?>" class="border2" style="padding-left:5px;"><img src="../slider_images/<?php echo($row['slide_image']);?>" style="max-width:500px; max-height:80px; text-align:center;" /></td> 
                    <td width="27%" bgcolor="<?php echo $bg3;?>" class="border2" style="padding-left:5px;"></td>
                    <td width="13%" align="center" bgcolor="<?php echo $bg3;?>" class="border3"><a href="edit_slide.php?slide_id=<?php echo($row['slide_id']);?>" title="Edit"><img src="images/icons/icon_action.jpg" width="20" height="17" border="0"></a></td>
                    <td width="11%" align="center" bgcolor="<?php echo $bg3;?>" class="border4">
                    <a href="slider.php?delete_slide=<?php echo($row['slide_id']);?>" title="Edit"><img src="images/icons/delete.png" width="20" height="17" border="0"></a>
...
href="expertise_detail.php?ex_id=<?php echo($row['ex_id']);?>&site_id=<?php echo $site_id;?>"><img src="images/icons/icon_delete_lit.jpg" width="13" height="17" border="0"></a>--></td>
                  ...
                  <tr>
                    <td height="50" align="center" bgcolor="#E0E0E0" class="lft_border" colspan="5"><a href="add_slide.php">Add Slide</a><!--<form action="add_page.php?site_id=<?php echo $site_id;?>" method="post">
