...
move_uploaded_file($_FILES["upload"]["tmp_name"],
      "../gallery/" . $_FILES["upload"]["name"]);
$filename = basename($_FILES['upload']['name']);


	$gallery_name=$_POST['gallery_name'];
	$qry="insert into gallery(gallery_name,image) values('$gallery_name','$filename')";
...
<table width="90%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="left" valign="top" style="padding-top:15px;">
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30" class="Black_Text"><span class="orange_text">Manage Gallery</span></td>
              </tr>
              <tr>
                <td align="center" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <td><input name="gallery_name" type="text" class="textbox1" id="gallery_name" style="border-width:1; border-style:solid;font-size:10; " size="40"></td>
                   <td>&nbsp;</td>
              </tr>
                  ...
                  <td><input name="upload" type="file" class="textbox1" id="upload" style="border-width:1; border-style:solid;font-size:10; " size="40"></td>
                   <td>&nbsp;</td>
              </tr>
                                ...
                                <tr>
                                  ...
                                  <td> <input type="submit" name="submit" id="submit" value="Add Images" /></td>
                                  <td>&nbsp;</td>
                                </tr>
                                    <tr>
                                  <td height="19" align="right" class="usr_info">&nbsp;</td>
              ...
              <tr>
			   ...
			   if ($_REQUEST['action']=="delete_image"){
				  $img_id=$_GET['img_id'];
				  $del="delete from gallery where img_id='$img_id'";
				  $delete=mysql_query($del) or die(mysql_error());
				}
   $sqlColors=mysql_query("select * from gallery order by img_id desc")or die(mysql_error());
			  $r=0;
  ...
  ?>
                              ...
                              <tr onMouseOver="this.style.backgroundColor='#f9f9ec';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#cccccc';">
                                <td width="20%"  height="50" class="border4" align="center"><img src="../gallery/<?php echo $rsColors['image']; ?>" width="40" height="40" ></td>
                                <td width="54%" class="border4" align="center" style="padding-left:5px;"><strong class="dataTable_title"><?php echo $rsColors['gallery_name']; ?></strong></td>
                                
                                
                                <td width="26%" class="border4" align="center" >
                                <a onClick="return confirmation()" href="gallery.php?img_id=<?php echo ($rsColors['img_id']."&action=delete_image"); ?>"><img src="images/icons/delete-16x16.png" alt="Delete Record" border="0"></a>                                </td>                                
