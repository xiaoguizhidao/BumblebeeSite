...
if(isset($_REQUEST['sports_name'])) {
	$sportname = $_REQUEST['sports_name'];
	$sportssort = $_REQUEST['sort'];
	$qr = "insert into sports (sports_name,sort) values ('$sportname','$sportssort')";
	if(mysql_query($qr)) {
		header("location: sports.php");
	} else {
		$msg = "Error adding sports ".mysql_error();
	}
}
?>
    ...
    <td width="100%" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%"  height="100%"border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td align="left" valign="top" style="padding-top:15px;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="borderbtm">
            ...
            <tr><td>Name</td><td><input type="text" name="sports_name"></td></tr>
            <tr><td>Sort Order</td><td><input type="text" name="sort"></td></tr>
            <tr><td></td><td><input type="submit" value="Add Sports"><input type="reset" value="Reset"></td></tr>
            </table>
            </form>
