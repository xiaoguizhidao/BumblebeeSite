...
$filename = basename($_FILES['file']['name']);
	$sort=$_REQUEST['sort'];
	$slide_idf=$_REQUEST['slide_id'];
$qryinsert="update slider set slide_image='$filename', sort='$sort' where slide_id=$slide_idf";
echo $qryinsert;
      ...
      <tr>
        ...
        <td align="left" valign="top" style="padding-top:15px;"><table border="1" width="100%" cellspacing="0" cellpadding="2" height="40" bgcolor="#F0F1F1">
          <tr>
			...
			$slideq=mysql_query("select * from slider where slide_id=$slideid");
			$slide = mysql_fetch_array($slideq);
			?>
			<form 

action="<?php echo($_SERVER['PHP_SELF']);?>?slide_id=<?php echo $slide['slide_id']; ?>" method="post" enctype="multipart/form-data" name="frmUpdateSub" id="frmUpdateSub"><br><br>
			  <table width="100%" border="0" cellpadding="4" cellspacing="0" class="main" align="center">

 <tr>
    <td width="10%">Slide</td>
    <td><input type="file" name="file"><img src="../slider_images/<?php echo $slide['slide_image']; ?>" style="height:85px"></td>
  </tr>
 <tr>
    <td width="10%">Sort</td>
    <td><input type="text" name="sort" value="<?php echo $slide['sort']; ?>"></td>
  </tr>
