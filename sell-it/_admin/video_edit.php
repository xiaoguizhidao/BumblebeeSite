...
<?php
$pdf_id=$_GET['pdf_id'];
$qryNews="select * from video where pdf_id='$pdf_id' limit 1";
...
if(isset($_POST['submit'])){
	...
	$qryUpdate="update video set pdf_name='$pdf_name',pdf_size='$pdf_size'";
      ...
      <tr>
        ...
        <td align="center" valign="top" style="padding-top:15px;">
            <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30" class="Black_Text"><span class="orange_text">Edit Videos</span></td>
              </tr>
              <tr>
                          ...
                          <td valign="middle" style="padding-top:10px;">
                              ...
                              <table width="100%" border="0" align="left" cellpadding="0" cellspacing="3">
                                <tr>
                                  ...
                                  <td><input type="file" name="pdf_image" id="pdf_image">
                                    <br>
                                    <img src="../video/<?php echo $rowNews['pdf_image']; ?>" height="50" width="50"></td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr>
                                  <td><strong>Video Name</strong></td>
                                  <td><input name="pdf_size" type="text" class="textbox1" id="pdf_size" style="border-width:1; border-style:solid;font-size:10; " value="<?php echo $rowNews['pdf_size'];?>" size="40"></td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr> 
