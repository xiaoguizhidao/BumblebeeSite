...
if(isset($_POST['subm'])) {
	...
	if($ext=="pdf") {
		if(file_exists("../pdf/catalog.pdf")) {
			unlink("../pdf/catalog.pdf");
			if(move_uploaded_file($_FILES['pdf']['tmp_name'],"../pdf/catalog.pdf")) {
			$msg = "file replaced";	
			} else {
				$msg = "file not replaced";	
			}
    ...
    <td width="100%" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%"  height="100%"border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td align="left" valign="top" style="padding-top:15px;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="borderbtm">
            <tr><td><a href="catalog.php">Manage Catelog pdf</a></td>
            <tr><td><?php echo $msg; ?></td>
            </tr>
            
            <tr><td>
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
            <label>Select PDF FILE</label><input type="file" name="pdf"><input type="submit" name="subm" value="Update PDF">
            </form>
            </td>
            </tr>
