...
<?php 
$hn_id=$_GET['service_id'];
$dqur="delete from employement where emp_id='$hn_id'";
...
" class="main_table_border"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="19%" class="Lblack" style="padding-left:5px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="11%" class="Lblack" style="padding-left:5px;">Title</td>
                  ...
                  <td width="0%" align="left"><img src="images/sap.jpg" width="2" height="12"></td>
                 <!-- <td width="28%" class="Lblack"style="padding-left:5px;">Image</td>-->
...
?> <tr>
                    <td width="12%" height="50" align="center" bgcolor="<?php echo $bg1;?>" class="lft_border"><?php echo($row['emp_head']);?></td>
                    <td width="37%" bgcolor="<?php echo $bg2;?>" class="border2" style="padding-left:5px;"><?php echo($row['emp_des']);?></td> 
                   <!-- <td width="27%" bgcolor="<?php echo $bg2;?>" class="border2" style="padding-left:5px;"><img src="../service/<?php echo($row['service_img']);?>" width="50" height="50" /></td>-->
                    <td width="13%" align="center" bgcolor="<?php echo $bg3;?>" class="border3"><a href="serviceedit.php?service_id=<?php echo($row['emp_id']);?>"><img src="images/icons/icon_action.jpg" width="20" height="17" border="0"></a></td>
                    <td width="11%" align="center" bgcolor="<?php echo $bg1;?>" class="border4"><a 

href="service.php?service_id=<?php echo($row['emp_id']);?>"><img src="images/icons/icon_delete_lit.jpg" width="13" height="17" border="0"></a></td>
                    </tr><?php }?>
                 
                 
                 
                  <tr>
                    <td height="50" align="center" bgcolor="#ffdfcb" class="lft_border" colspan="5"><form action="addService.php" method="post">
	<input type="submit" value="Add Employment Service" name="submit" id="submit" align="middle"/>
</form></td>
