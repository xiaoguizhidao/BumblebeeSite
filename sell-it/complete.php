...
<h2>Completed</h2>
<?php
$tradequery = "select t.*, a.*,u.first_name, DATE_ADD(t.sate_time, INTERVAL 15 DAY) as expiry from trades t inner join address a ON t.address_to_ship = a.add_id inner join users u on u.user_id = t.user_id  where t.user_id = ".$userid." and t.sessid = '".$sess_id."'";
      ...
      <table width="550" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
        <tbody><tr>
          <td><table width="500" align="left">
              <tbody><tr>
                <td><p style="padding-left:20px;padding-right:15px;padding-top:0px;color:#666666;font-size:12px;line-height:18px;font-family:Arial,Helvetica,sans-serif"> Hi '.$shipdata['first_name'].',<br>
                    <br>
                    We\'re excited that you\'ve decided to sell your ';
					$myprosname = mysql_query("select item_name from cart where sessid = '".$sess_id."'");
					$koma = 0;
					$count=mysql_num_rows($myprosname);
					...
					$koma++;
						...
						if($count==1){
							$mysg .= '<storng>'.$pronames[0]." <storng> ";
							}else{
						$mysg .= '<storng>'.$pronames[0];
						if($count==$koma){
						$mysg .='';
						}else{
							$mysg .=", " ;
		...
		$mysg .= ' Device to Bumblebee Wireless. Your free shipping label and instructions will be mailed shortly.</p>
                  ...
                  <ol style="margin-left:20px;padding:0px">
                   <li style="color:#666666;font-size:12px;line-height:18px;font-family:Arial,Helvetica,sans-serif;font-weight:bold">Prepare your device for shipping. <a href="http://bumblebeewireless.com/faq/index/categoryshow/cat_id/6/">How to prepare your device.</a> </li>
					...
					$koma2 = 0;
					$count=mysql_num_rows($myprosname2);
					$secl=$count-1;
					...
					$koma2++;
						...
						if($count==1){
							$mysg .= '<storng>'.$pronames2[0]." <storng> ";
							}else{
						$mysg .= '<storng>'.$pronames2[0];
						if($count==$koma2){
						$mysg .='';
						}
						elseif($secl==$koma2){
...
<li style="color:#666666;font-size:12px;line-height:18px;font-family:Arial,Helvetica,sans-serif;font-weight:bold">Affix your shipping label to box and drop off your item to your nearest shipping carrier, listed on the pre-paid label we will be sending you shortly.</li>
                  </ol>
              ...
              <tr>
                <td><p style="padding-left:20px;padding-right:15px;padding-top:0px;color:#666666;font-size:12px;line-height:18px;font-family:Arial,Helvetica,sans-serif">                    Thanks again,<br>
					...
					while($pronames3 = mysql_fetch_array($myprosname3)) {
						$mysg .= '<tr>
                        	            ...
                        	            <span style="font-size:12px;line-height:16px;font-family:Arial,Helvetica,sans-serif;color:#333333">
										 ...
										 date('m-d-Y',strtotime($shipdata['expiry'])).'</span></span></span>
                        	            </td>                       	           
                        	          </tr>';
                           		  ...
                           		  <tr>
                           		    <td>
                           		     <p style="padding-left:20px;padding-right:15px;padding-top:0px;color:#666666;font-size:12px;line-height:18px;font-family:Arial,Helvetica,sans-serif">
                <b>Box Total: $'.$boxamout.'</b>
                                 ...
                                 <tr>
                           		    <td>
                           		     <p style="padding-left:20px;padding-right:15px;padding-top:0px;color:#ff0000;font-size:12px;line-height:18px;font-family:Arial,Helvetica,sans-serif">
...
<li>Remove passwords</li>
      ...
      <li><a href="http://bumblebeewireless.com/faq/index/categoryshow/cat_id/3/" target="_blank" style="text-decoration:underline; color:#213dff;">How to Prepare Your Device.</a></li>
    </ul>
</div>
</div>
        </div>
...
<li><a href="http://bumblebeewireless.com/faq/" target="_blank" style="text-decoration:underline; color:#213dff;">How to ship</a></li>
    </ul>
</div>
</div>
        </div>
...
<a href="http://www.smartaddon.com/?share" title="Share Button" style="text-decoration:underline; color:#213dff;" onClick="return sa_tellafriend('http://bumblebeewireless.com','email')">Click here</span></a>
...
<h2><a href="http://bumblebeewireless.com/faq/index/categoryshow/cat_id/3/" target="_blank">▸ Remove Passwords</a></h2>
...
<!--<a href="http://bumblebeewireless.com/faq/index/categoryshow/cat_id/6/" target="_blank" style="color:#213dff;">How to remove your password &gt;</a>-->
        </div>
        <div id="step_2" class="step_detail">
<h2><a href="http://bumblebeewireless.com/faq/" target="_blank">▸ Deactivate your service</a></h2>
<p>It is very important that your contact your carrier to terminate service to this phone, and pay any remaining balance.</p>
<!--<a href="http://bumblebeewireless.com/faq/index/categoryshow/cat_id/6/" target="_blank" style="color:#213dff;">How to deactivate your service &gt;</a>-->
        </div>
        <div id="step_3" class="step_detail">
<h2><a href="http://bumblebeewireless.com/faq/index/categoryshow/cat_id/3/" target="_blank">▸ Save your data</a></h2>
...
<!--<a href="http://bumblebeewireless.com/faq/index/categoryshow/cat_id/6/" target="_blank" style="color:#213dff;">How to save and erase your data &gt;</a>-->
        </div>
      </div> 
       <br> 
  </section>
